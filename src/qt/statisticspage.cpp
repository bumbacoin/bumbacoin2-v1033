...
void StatisticsPage::updateStatistics()
{
    ...
    QString phase = "";
    if (pindexBest->nHeight < 21601)
    {
        phase = "X11 POW+POS";
    }
    else if (pindexBest->nHeight > 21601)
    {
        phase = "POS";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " BUMBA" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BUMBA" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BUMBA");
    }
